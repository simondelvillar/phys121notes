...
\begin{equation}
    \dfrac{d}{dx} \left(\dfrac{y}{\left(\sqrt{x^2+y^2}\right)}\right) = \dfrac{y^2}{\left(x^2+y^2\right)^{3/2}}  
\end{equation}

\noindent Equation (9) can be rewritten as the following, knowing that y is a constant.
\begin{equation}
...
\noindent To simplify further, we can use the Fundamental Theorem of Calculus (FTC) which states that:
\begin{equation}
    \int\limits_{a}^{b}\dfrac{df}{dx} = f(b)-f(a)
\end{equation}

\noindent Invoking FTC/equation (11), we can recognize this form in our integral and apply it into the infinite rod problem: 
\begin{align*}
