...
\newcommand{\compactdatetime}{%
  ...
  \begingroup
    ...
    \count1=\count0
    \divide\count0 by 60 % hours
    \count2=\count0 % save hours
    \multiply\count0 by 60
    \advance\count1 by -\count0 % minutes
    % 12-hour conversion
    \ifnum\count2=0 \count3=12 \def\ampm{AM}\else
    \ifnum\count2<12 \count3=\count2 \def\ampm{AM}\else
      \count3=\numexpr\count2-12\relax \def\ampm{PM}\fi
    \fi
    \ifnum\count3=0 \count3=12\fi
    \the\count3:\ifnum\count1<10 0\fi\the\count1~\ampm
  \endgroup
}
% --------------------
% Document Info
...
\addcontentsline{toc}{section}{Recent Updates}

\begin{tcolorbox}[
  title={Recent Updates \hfill Last updated: \compactdatetime},
  colback=gray!5,
  colframe=black!40,
  boxrule=0.5pt,
  arc=4pt,
...
% Angle arcs
\pic [draw, "$\theta$", angle radius=15, angle eccentricity=1.3]
    {angle = P1--O--A};

\pic [draw, "$2\theta$", angle radius=25, angle eccentricity=1.3, above]
    {angle = P1--O--P2};
...
\begin{align*}
    s = 2r\theta > 0 = 2r\sin\theta \\
    s = \cancel{2r}\theta > 0 = \cancel{2r}\sin\theta \\
\end{align*}
